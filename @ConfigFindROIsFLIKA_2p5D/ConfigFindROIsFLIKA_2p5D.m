classdef ConfigFindROIsFLIKA_2p5D < ConfigFindROIsFLIKA
%ConfigFindROIsFLIKA_2p5D - Parameters for 2.5D FLIKA-based ROI identification
%
%   The ConfigFindROIsFLIKA_2p5D class is a configuration class that contains
...
%
%   ConfigFindROIsFLIKA_2p5D is a subclass of matlab.mixin.Copyable, which
%   is itself a subclass of handle, meaning that ConfigFindROIsFLIKA_2p5D
...
%   ConfigFindROIsFLIKA_2p5D object used in one place will also lead to
%   changes in another (perhaps undesired) place.
%
% ConfigFindROIsFLIKA_2p5D public properties
...
%   
% ConfigFindROIsFLIKA_2p5D public methods
%   ConfigFindROIsFLIKA_2p5D - ConfigFindROIsFLIKA_2p5D class constructor
...
%
% ConfigFindROIsFLIKA_2p5D static methods
%   from_preset     - Create a config object from a preset
%
% ConfigFindROIsFLIKA_2p5D public events:
%   ProcessNow      - Notifies listeners to process an object
%
%   See also ConfigFindROIsFLIKA_2D, ConfigFindROIsFLIKA_3D,
%   ConfigFindROIsFLIKA, ConfigFindROIsDummy, Config, ConfigCellScan,
%   CalcFindROIsFLIKA_2p5D, CellScan
...
%   along with this program.  If not, see <http://www.gnu.org/licenses/>.
    ...
    properties (Constant, Access = protected)
        ...
        classCalc = 'CalcFindROIsFLIKA_2p5D';
    ...
    methods 
        ...
        function ConfigFLIKA_2p5DObj = ConfigFindROIsFLIKA_2p5D(varargin)
        %ConfigFindROIsFLIKA_2p5D - ConfigFindROIsFLIKA_2p5D class constructor
        %
        %   OBJ = ConfigFindROIsFLIKA_2p5D() creates a ConfigFindROIsFLIKA_2p5D
        %   object OBJ with default values for all properties.
        %
        %   OBJ = ConfigFindROIsFLIKA_2p5D(..., 'property', value, ...) or
        %   OBJ = ConfigFindROIsFLIKA_2p5D(..., propStruct, ...) 
        %
        ...
        %   ConfigFindROIsFLIKA_2p5D class. The argument parsing is done by
        ...
        %   ConfigFindROIsFLIKA_2p5D.from_preset, ConfigFindROIsFLIKA_2D,
        ...
        %   ConfigFindROIsFLIKA, Config, ConfigCellScan
            ...
            ConfigFLIKA_2p5DObj = ...
                ConfigFLIKA_2p5DObj@ConfigFindROIsFLIKA(varargin{:});
    ...
    methods (Static)
        ...
        %from_preset - Create a config object from a preset
        %
        %   OBJ = ConfigFindROIsFLIKA_2p5D.from_preset(PRESET) creates a
        ...
        %
        %   OBJ = ConfigFindROIsFLIKA_2p5D.from_preset(PRESET, ARG1, ARG2, ...)
        %   passes all additional arguments to the ConfigFindROIsFLIKA_2p5D
        %   object constructor.  This can be useful for creating slight
        %   modifications of the preset configurations.
        %
        %   See also ConfigFindROIsFLIKA_2p5D,
        %   ConfigFindROIsFLIKA_2p5D.ConfigFindROIsFLIKA_2p5D
            ...
            obj = ConfigFindROIsFLIKA_2p5D(presetArgs, varargin{:});
            warning(wngState)
