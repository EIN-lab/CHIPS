function varargout = plot_ICAsigs(self, objPI, hAx, varargin)
...
% this is why they are currently hardcoded
mode = 'series';
spike_thresh = 2;
deconvtau = 0;
normalization = 1;
...
% Call helper function to find spikes
[~, spt, spc] = utils.cellsort.CellsortFindspikes(ica_sig, ...
    spike_thresh, dt, deconvtau, normalization);
