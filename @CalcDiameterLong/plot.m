...
%plot - Plot a figure
%
%   plot(OBJ, OBJ_PI) plots the default figure for the CalcDiameterLong
...
%
%       'diam_profile' -> A figure showing the diameter profile image
%
%       'graphs' ->    A figure showing the graph of diameter vs time
%
...
%
%   See also LineScanDiam.plot, FrameScan.plot, Data.plot,
%   Data.plot_graphs, LineScanDiam, FrameScan, ICalcDiameterLong
...
if flag > 0
    switch plotName
        ...
        case {'diam_profile'}
            ...
            hAx = self.plot_diam_profile(objPI, hAx, ...
                varargin{idxStart:end});
        ...
        otherwise
            ...
            error('CalcDiameterFWHM:Plot:UnknownPlot', ...
