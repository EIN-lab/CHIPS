classdef DataFindROIsFLIKA_3D < DataFindROIsFLIKA
%DataFindROIsFLIKA_3D - Data from FLIKA-based ROI identification
%
%   The DataFindROIsFLIKA_3D class contains the data generated by
%   CalcFindROIsFLIKA.
%
% DataFindROIsFLIKA_3D public properties inherited from Data:
...
%
% DataFindROIsFLIKA_3D public properties:
...
%   distance        - The distance travelled by the ROIs [µm]
%   duration        - The ROI durations [s]
%   onset           - The signal onset times [s]
...
%
% DataFindROIsFLIKA_3D public methods:
...
%   DataFindROIsFLIKA, DataFindROIs, Data, CalcFindROIsFLIKA_3D, CellScan
...
%   along with this program.  If not, see <http://www.gnu.org/licenses/>.
    ...
    properties
        ...
        %distance - The distance travelled by the ROIs [µm]
        %
        %   A vector of the maximal travelled distances of the centroids
        %   within a ROI.
        %
        %   See also Metadata.pixelSize
        distance
        ...
        %onset - The signal onset times [s]
        %
        %   A vector of the first times at which the signal is detected
        %
        %   See also Metadata.frameRate
        onset
    ...
    properties (Constant, Access = protected)
        ...
        listProcessed = {'area', 'centroidT', 'centroidX', 'centroidY', ...
            'distance', 'duration', 'puffSignificantMask', 'onset', ...
            'roiIdxs', 'roiMask', 'roiNames', 'volume'};
        ...
        listOutput = {'roiNames', 'area', 'centroidX', 'centroidY', ...
            'centroidT', 'duration', 'onset', 'volume'};
    ...
    methods
        ...
        function self = set.distance(self, val)
        ...
        function self = set.onset(self, val)
            
            % Check property is a vector containing real numerics
            utils.checks.real_num(val, 'onset')
            utils.checks.vector(val, 'onset')
